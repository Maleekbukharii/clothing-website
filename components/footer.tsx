  ...
  return (
    <footer className="footer bg-base-300 text-base-content p-10">
      ...
      <nav>
        ...
        <Link href="#" className="link link-hover">Shipping</Link>
        <Link href="#" className="link link-hover">Return & exchange</Link>
        <Link href="#" className="link link-hover">Cancellation</Link>
      </nav>
      <nav>
        <h6 className="footer-title">Customer service</h6>
        <Link href="#" className="link link-hover">Track your order</Link>
        <Link href="#" className="link link-hover">FAQ's</Link>
